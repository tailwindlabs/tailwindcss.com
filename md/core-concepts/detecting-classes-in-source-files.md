...
_Don't construct class names dynamically_
...
_Always use complete class names_
...
_Don't use props to build class names dynamically_
...
_Always map props to static class names_
