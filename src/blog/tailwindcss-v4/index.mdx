...
- [Simplified installation](#) — fewer dependencies, zero configuration, and only one line of code in your CSS file.
...
- [Even more new utilities and variants](#) — support for `color-scheme`, `field-sizing`, complex shadows, `inert`, and more.
...
Learn more about [automatic source detection](/docs/detecting-classes-in-source-files) in the documentation.
