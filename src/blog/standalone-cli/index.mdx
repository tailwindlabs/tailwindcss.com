...
<div className="bg-yellow-100 border-l-4 border-yellow-500 p-4">
  <strong>Warning:</strong> This blog post was created for TailwindCSS v3.
  
  Therefore, the installation steps included may differ starting from v4. To clearly distinguish between the two posts, we <Link href="/blog/2025-04-18-tailwind-cli">mentioned the current steps related to Tailwind CLI</Link> in a new blog post.
</div>
