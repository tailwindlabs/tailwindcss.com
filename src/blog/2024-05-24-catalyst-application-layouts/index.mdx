...
<Image alt="Catalyst application layout preview" src={catalystHeader} />
...
<Image alt="Sidebar layout example" src={sidebarLayout} />
...
<Image alt="Stacked layout example" src={stackedLayout} />
...
<Image alt="Sidebar layout in dark mode" src={layoutDarkMode} />
