  ...
  <div className="group grid grid-cols-[1fr_auto] items-baseline-last gap-x-4 px-4 py-6 hover:bg-gray-50 dark:hover:bg-gray-950/50">
    <div className="grid grid-cols-[32px_1fr] gap-x-4">
      ...
      <p className="col-start-2 text-sm">
        Working on the future of space travel at
        <br />
        <a href="#" className="text-blue-500 underline dark:text-blue-400">
          planeteria.tech
        </a>
      </p>
    </div>
    <p className="text-lg group-hover:text-blue-500 dark:group-hover:text-blue-400">↗</p>
  </div>
  <div className="group grid grid-cols-[1fr_auto] items-baseline-last gap-x-4 px-4 py-6 hover:bg-gray-50 dark:hover:bg-gray-950/50">
    <div className="grid grid-cols-[32px_1fr] gap-x-4">
      <img
...
<div class="group grid grid-cols-[1fr_auto] items-baseline-last gap-x-4 px-4 py-6">
  ...
  <p class="text-lg group-hover:text-blue-500">↗</p>
</div>
```
...
version using npm: ```sh npm install tailwindcss@latest
