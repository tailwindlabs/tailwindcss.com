...
<Example>
  {
    <div className="relative grid h-48 place-items-center">
      <div className="-mr-10 flex gap-4 max-sm:-mr-32">
        ...
        <button className="relative rounded-full bg-linear-to-b from-white/10 to-white/20 to-70% px-4 py-2 text-sm font-semibold text-black shadow-md ring inset-shadow-2xs ring-black/20 inset-shadow-white/10 dark:text-white">
          See pricing
        </button>
      </div>
    </div>
...
<div class="flex gap-4">
  ...
  <button class="text-black dark:text-white ...">See pricing</button>
</div>
```
...
We've also added `self-baseline-last` for when you need to align just a single items, and not all items in the flex or grid container.
