...
<Example resizable>
  {
    <div className="grid grid-cols-1 gap-8">
      <div>
        <p className="text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">justify-center</p>
      ...
      <div>
        <p className="text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">
          justify-center-safe
        </p>
