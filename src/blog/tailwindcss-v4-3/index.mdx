...
<table>
  <thead>
    <tr>
      <th></th>
      <th className="text-right">@tailwindcss/postcss</th>
      <th className="text-right">@tailwindcss/webpack</th>
  ...
  <tbody>
    <tr>
      <td>Build time</td>
      <td className="text-right">931.53ms</td>
      <td className="text-right">429ms</td>
      <td className="text-right">2.17x</td>
    </tr>
  </tbody>
</table>
}
