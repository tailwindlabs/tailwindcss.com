...
Check out the [live preview](https://compass.tailwindui.com) as always for the full experience.
...
![Neurological Proof](https://assets.tailwindcss.com/templates/compass/neuro-proof.{scheme}.png) <!-- [!code highlight:1] -->
...
![Neurological Proof|2000x990](https://assets.tailwindcss.com/templates/compass/neuro-proof.{scheme}.png) <!-- [!code highlight:1] -->
