  ...
  return (
    <div id={meta.containerId} className="w-full flex">
      <div className="min-w-0 flex-auto px-4 sm:px-6 xl:px-8 pt-10 pb-24 lg:pb-16">
        ...
        <Link href={`https://github.com/tailwindlabs/tailwindcss.com/blob/master/src/pages${router.pathname}.mdx`}>
          <a className="flex leading-6 font-medium items-center mt-10 hover:text-gray-900 transition-colors duration-200">
            <svg className="mr-2" width="20" height="20" viewBox="0 0 16 16" fill="currentColor">
              <path
                fillRule="evenodd"
