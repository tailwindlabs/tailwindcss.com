...
<Example resizable>
  {
    <div className="align-start grid gap-4 text-center font-mono text-xs font-bold text-white">
      <div className="relative grid w-full rounded-lg">
        ...
        <div className="relative max-inline-96 rounded-lg bg-blue-500 px-4 py-2">max-inline-96</div>
      </div>
      <div className="relative grid w-full rounded-lg">
        <Stripes border className="absolute inset-0 h-full rounded-lg" />
        <div className="relative max-inline-80 rounded-lg bg-blue-500 px-4 py-2">max-inline-80</div>
      </div>
      <div className="relative grid w-full rounded-lg">
        <Stripes border className="absolute inset-0 h-full rounded-lg" />
        <div className="relative max-inline-64 rounded-lg bg-blue-500 px-4 py-2">max-inline-64</div>
      </div>
      <div className="relative grid w-full rounded-lg">
        <Stripes border className="absolute inset-0 h-full rounded-lg" />
        <div className="relative max-inline-48 rounded-lg bg-blue-500 px-4 py-2">max-inline-48</div>
      </div>
      <div className="relative grid w-full rounded-lg">
        <Stripes border className="absolute inset-0 h-full rounded-lg" />
        <div className="relative max-inline-40 rounded-lg bg-blue-500 px-4 py-2">max-inline-40</div>
      </div>
      <div className="relative grid w-full rounded-lg">
        <Stripes border className="absolute inset-0 h-full rounded-lg" />
        <div className="relative max-inline-32 rounded-lg bg-blue-500 px-4 py-2">max-inline-32</div>
      </div>
      <div className="relative grid w-full rounded-lg">
        <Stripes border className="absolute inset-0 h-full rounded-lg" />
        <div className="relative max-inline-24 rounded-lg bg-blue-500 px-4 py-2">max-inline-24</div>
      </div>
    </div>
  }
</Example>
...
<div class="inline-full max-inline-24 ...">max-inline-24</div>
```
...
<Example resizable>
  {
    <div className="align-start grid gap-4 text-center font-mono text-xs font-bold text-white">
      <div className="relative grid w-full rounded-lg">
        <Stripes border className="absolute inset-0 h-full rounded-lg" />
        <div className="relative max-inline-9/10 truncate rounded-lg bg-indigo-500 px-4 py-2 text-nowrap">max-inline-9/10</div>
      </div>
      <div className="relative grid w-full rounded-lg">
        <Stripes border className="absolute inset-0 h-full rounded-lg" />
        <div className="relative max-inline-3/4 truncate rounded-lg bg-indigo-500 px-4 py-2 text-nowrap">max-inline-3/4</div>
      </div>
      <div className="relative grid w-full rounded-lg">
        <Stripes border className="absolute inset-0 h-full rounded-lg" />
        <div className="relative max-inline-1/2 truncate rounded-lg bg-indigo-500 px-4 py-2 text-nowrap">max-inline-1/2</div>
      </div>
      <div className="relative grid w-full rounded-lg">
        <Stripes border className="absolute inset-0 h-full rounded-lg" />
        <div className="relative max-inline-1/3 truncate rounded-lg bg-indigo-500 px-4 py-2 text-nowrap">max-inline-1/3</div>
      </div>
    </div>
  }
</Example>
...
<Example resizable>
  {
    <div className="dark:highlight-white/5 relative mx-auto flex max-inline-md items-center gap-6 overflow-hidden rounded-xl bg-white shadow-lg ring-1 ring-black/5 dark:bg-gray-800">
      <img
