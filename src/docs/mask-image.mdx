...
<Example padding={false}>
  {
    <div className="grid grid-cols-1 items-end gap-x-2 gap-y-8 p-8 text-center font-mono text-xs font-medium text-gray-500 max-sm:justify-between max-sm:px-2 sm:grid-cols-2 dark:text-gray-400">
      ...
      <div className="flex flex-col items-center gap-3">
        <p>mask-b-from-50% mask-b-to-90%</p>
        <div className="grid aspect-3/2 w-44 grid-cols-1">
          <Stripes className="col-start-1 row-start-1 rounded-lg" border />
      ...
      <div className="flex flex-col items-center gap-3">
        <p>mask-l-from-20% mask-l-to-80%</p>
        <div className="grid aspect-3/2 w-44 grid-cols-1">
          <Stripes className="col-start-1 row-start-1 rounded-lg" border />
...
<Example>
  {
    <div className="grid grid-cols-1 items-end gap-x-2 gap-y-8 p-8 text-center font-mono text-xs font-medium text-gray-500 max-sm:justify-between max-sm:px-2 sm:grid-cols-2 dark:text-gray-400">
      ...
      <div className="flex flex-col items-center text-xs">
        <Stripes className="aspect-3/2 w-48 rounded-lg" border>
          <div className="h-full rounded-lg bg-[url(https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&h=1000&q=80)] mask-t-from-90% mask-t-to-90% mask-r-from-90% mask-r-to-90% mask-conic-305 mask-conic-from-50% mask-conic-to-50% bg-cover bg-center mask-size-[3.75%_4.875%]"></div>
        </Stripes>
      </div>
    </div>
  }
...
<div class="mask-t-from-90% mask-t-to-90% mask-r-from-90% mask-r-to-90% mask-conic-305 mask-conic-from-50% mask-conic-to-50% mask-size-[3.75%_4.875%] bg-[url(/img/mountains.jpg)] ..."></div>
```
