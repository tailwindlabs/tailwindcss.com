...
<ApiTable
  rows={[
    ...
    [
      "mask-t-from-<number>",
      "linear-gradient(to top, black calc(var(--spacing \* <number>)), transparent var(--mask-bottom-to)",
    ],
    ["mask-t-from-<percentage>", "linear-gradient(to top, black <percentage>, transparent var(--mask-bottom-to)"],
    [
      "mask-t-to-<number>",
      "linear-gradient(to top, black var(--mask-top-from), transparent calc(var(--spacing \* <number>))",
    ],
    ["mask-t-to-<percentage>", "linear-gradient(to top, black var(--mask-top-from), transparent <percentage>"],
  ]}
/>
...
<div className="grid grid-cols-2 items-end gap-x-2 gap-y-8 p-8 text-center font-mono text-sm font-medium text-gray-500 max-sm:justify-between max-sm:px-2 dark:text-gray-400">
  <div className="flex flex-col items-center text-xs">
    ...
    <Stripes className="mt-3 aspect-[1.33] w-40 rounded-lg max-sm:w-3" border>
      <div className="h-full rounded-lg bg-[url(https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&h=1000&q=80)] mask-t-from-50% mask-t-to-90% bg-cover bg-center mask-no-repeat"></div>
    </Stripes>
  </div>
  <div className="flex flex-col items-center text-xs">
    <p>mask-r-from-50%</p>
    <p>mask-r-to-90%</p>
    <Stripes className="mt-3 aspect-[1.33] w-40 rounded-lg max-sm:w-3" border>
      <div className="mask-r-from-white h-full rounded-lg bg-[url(https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&h=1000&q=80)] mask-r-from-50% mask-r-to-90% bg-cover bg-center mask-no-repeat"></div>
    </Stripes>
  </div>
  <div className="flex flex-col items-center text-xs">
    <p>mask-b-from-50%</p>
    <p>mask-b-to-90%</p>
    <Stripes className="mt-3 aspect-[1.33] w-40 rounded-lg max-sm:w-3" border>
      <div className="h-full rounded-lg bg-[url(https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&h=1000&q=80)] mask-b-from-50% mask-b-to-90% bg-cover bg-center mask-no-repeat"></div>
    </Stripes>
  </div>
  <div className="flex flex-col items-center text-xs">
    <p>mask-l-from-50%</p>
