...
<div className="relative py-8">
  ...
  <div className="mask-b-from-70% border-y border-y-gray-200 bg-white dark:border-y-gray-800 dark:bg-gray-950">
    <div>
...
<div class="relative">
  ...
  <div class="mask-b-from-70% max-h-96 ...">
    <table>
      <!-- ... -->
    </table>
  </div>
...
<div className="mx-auto max-w-lg p-16">
  <div className="bg-repeat-none mask-radial-to-90% mask-radial-at-left mask-radial-from-40% mask-circle -ml-2.5 aspect-square w-[calc(100%_+_--spacing(2.5))] max-w-sm bg-[url(/keyboard-light.png)] mask-radial bg-cover bg-no-repeat dark:bg-[url(/keyboard-dark.png)]" />
  <div className="mt-6 text-sm font-medium">
    <p className="font-mono text-xs text-gray-500 uppercase dark:text-gray-500">Speed</p>
    <p className="mt-4 text-base text-gray-700 dark:text-gray-300">Built for power users</p>
