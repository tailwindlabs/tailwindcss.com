...
<svg class="fill-cyan-500 drop-shadow-lg drop-shadow-cyan-500/50 ...">Subscribe</svg>
<svg class="fill-blue-500 drop-shadow-lg drop-shadow-blue-500/50 ...">Subscribe</svg>
<svg class="fill-indigo-500 drop-shadow-lg drop-shadow-indigo-500/50 ...">Subscribe</svg>
```
...
<CustomizingYourThemeColors utility="drop-shadow" />
