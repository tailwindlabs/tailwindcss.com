...
<div className="flex flex-col py-8">
  <Stripes className="h-40 w-full rounded-lg" border>
    <div className="mask-size-[50px_50px] h-full rounded-lg bg-[url(https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&h=1000&q=80)] mask-radial-from-100% mask-radial-closest-side bg-cover bg-center mask-center mask-repeat"></div>
  </Stripes>
</div>
...
<div class="mask-size-[50px_50px] mask-[url(/img/circle.png)] mask-repeat ..."></div>
```
...
<div className="flex flex-col py-8">
  <Stripes className="h-40 w-full rounded-lg" border>
    <div className="mask-size-[50px_50px] h-full rounded-lg bg-[url(https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&h=1000&q=80)] mask-radial-from-100% mask-radial-closest-side bg-cover bg-center mask-center mask-repeat-x"></div>
  </Stripes>
</div>
...
<div class="mask-size-[50px_50px] mask-[url(/img/circle.png)] mask-repeat-x ..."></div>
```
...
<div className="flex flex-col py-8">
  <Stripes className="h-40 w-full rounded-lg" border>
    <div className="mask-size-[50px_50px] h-full rounded-lg bg-[url(https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&h=1000&q=80)] mask-radial-from-100% mask-radial-closest-side bg-cover bg-center mask-center mask-repeat-y"></div>
  </Stripes>
</div>
...
<div class="mask-size-[50px_50px] mask-[url(/img/circle.png)] mask-repeat-y ..."></div>
```
...
<div className="flex flex-col py-8">
  <Stripes className="h-40 w-full rounded-lg" border>
    <div className="mask-size-[50px_50px] h-full rounded-lg bg-[url(https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&h=1000&q=80)] mask-radial-from-100% mask-radial-closest-side bg-cover bg-center mask-repeat-space"></div>
  </Stripes>
</div>
}
...
<div class="mask-size-[50px_50px] mask-[url(/img/circle.png)] mask-repeat-space ..."></div>
```
...
<div className="flex flex-col py-8">
  <Stripes className="h-40 w-full rounded-lg" border>
    <div className="mask-size-[50px_50px] h-full rounded-lg bg-[url(https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&h=1000&q=80)] mask-radial-from-100% mask-radial-closest-side bg-cover bg-center mask-repeat-round"></div>
  </Stripes>
</div>
...
<div class="mask-size-[50px_50px] mask-[url(/img/circle.png)] mask-repeat-round ..."></div>
```
...
<div className="flex flex-col py-8">
  <Stripes className="h-40 w-full rounded-lg" border>
    <div className="mask-size-[50px_50px] h-full rounded-lg bg-[url(https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&h=1000&q=80)] mask-radial-from-100% mask-radial-closest-side bg-cover bg-center mask-center mask-no-repeat"></div>
  </Stripes>
</div>
...
<div class="mask-size-[50px_50px] mask-[url(/img/circle.png)] mask-no-repeat ..."></div>
```
