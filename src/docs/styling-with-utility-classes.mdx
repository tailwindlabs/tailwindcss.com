...
<Example>
  {
    <div className="mx-auto flex max-w-sm items-center gap-x-4 rounded-xl bg-white p-6 ring shadow-lg ring-black/5">
      <svg className="size-12 shrink-0" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
        <defs>
...
Learn more about how this works in [detecting classes in source files](/docs/how-classes-are-generated).
