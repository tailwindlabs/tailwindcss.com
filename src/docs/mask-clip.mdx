...
<div class="border-3 mask-[url(/img/circle.png)] mask-clip-border p-1.5 ..."></div>
<div class="border-3 mask-[url(/img/circle.png)] mask-clip-padding p-1.5 ..."></div>
<div class="border-3 mask-[url(/img/circle.png)] mask-clip-content p-1.5 ..."></div>
```
