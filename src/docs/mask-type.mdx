...
export const description = "Utilities for controlling how an SVG element's mask is interpreted.";
...
Use the `mask-type-alpha` and `mask-type-luminance` utilities to control the type of an SVG element's mask:
...
<div>
  ...
  <p className="mt-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">mask-type-alpha</p>
  <Stripes
    border
  ...
  <p className="mt-3 text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">mask-type-luminance</p>
</div>
...
<svg>
  <mask id="blob1" class="mask-type-luminance fill-gray-700/70">
    <path d="..."></path>
  </mask>
  <image href="/img/mountains.jpg" height="100%" width="100%" mask="url(#blob1)" />
</svg>
