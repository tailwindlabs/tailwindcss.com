...
Use `justify-self-center` or `justify-self-center-safe` to align a grid item along the center of its inline axis:
...
<Example resizable>
  {
    <div className="grid grid-cols-1 gap-8">
      <div>
        <p className="font-mono text-xs font-medium text-gray-500 dark:text-gray-400">justify-center-end</p>
      ...
      <div>
        <p className="font-mono text-xs font-medium text-gray-500 dark:text-gray-400">justify-self-center-safe</p>
        <div className="mt-2 grid auto-rows-fr grid-cols-3 justify-items-stretch gap-10 text-center font-mono text-sm leading-6 font-bold text-white">
...
```html
<!-- [!code classes:justify-self-center,justify-self-center-safe] -->
<div class="grid justify-items-stretch ...">
  <!-- ... -->
...
Use `justify-self-end` or `justify-self-end-safe` utilities to align a grid item to the end of its inline axis:
...
<div className="grid grid-cols-1 gap-8">
  <div>
    <p className="font-mono text-xs font-medium text-gray-500 dark:text-gray-400">justify-self-end</p>
    <div className="mt-2 grid auto-rows-fr grid-cols-3 justify-items-stretch gap-10 text-center font-mono text-sm leading-6 font-bold text-white">
  ...
  <div>
    <p className="font-mono text-xs font-medium text-gray-500 dark:text-gray-400">justify-self-end-safe</p>
    <div className="mt-2 grid auto-rows-fr grid-cols-3 justify-items-stretch gap-10 text-center font-mono text-sm leading-6 font-bold text-white">
