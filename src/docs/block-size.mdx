...
<Example>
  {
    <div className="flex block-96 items-end justify-center space-x-4 font-mono text-xs font-bold text-white">
      <div className="relative flex block-full items-end">
        ...
        <div className="relative flex block-full w-8 items-end justify-center rounded-lg bg-sky-500">
          <div className="mb-6 -rotate-90 text-left text-nowrap">block-full</div>
        </div>
      </div>
      <div className="relative flex block-full items-end">
        <Stripes border className="absolute inset-0 block-full rounded-lg" />
        <div className="relative flex block-9/10 w-8 items-end justify-center rounded-lg bg-sky-500">
          <div className="mb-6 -rotate-90 text-left text-nowrap">block-9/10</div>
        </div>
      </div>
      <div className="relative flex block-full items-end">
        <Stripes border className="absolute inset-0 block-full rounded-lg" />
        <div className="relative flex block-3/4 w-8 items-end justify-center rounded-lg bg-sky-500">
          <div className="mb-6 -rotate-90 text-left text-nowrap">block-3/4</div>
        </div>
      </div>
      <div className="relative flex block-full items-end">
        <Stripes border className="absolute inset-0 block-full rounded-lg" />
        <div className="relative flex block-1/2 w-8 items-end justify-center rounded-lg bg-sky-500">
          <div className="mb-6 -rotate-90 text-left text-nowrap">block-1/2</div>
        </div>
      </div>
      <div className="relative flex block-full items-end">
        <Stripes border className="absolute inset-0 block-full rounded-lg" />
        <div className="relative flex block-1/3 w-8 items-end justify-center rounded-lg bg-sky-500">
          <div className="mb-6 -rotate-90 text-left text-nowrap">block-1/3</div>
        </div>
      </div>
    </div>
  }
