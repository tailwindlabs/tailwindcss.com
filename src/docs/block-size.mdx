...
<Example>
  {
    <div className="flex items-end justify-center space-x-4 font-mono text-xs font-bold text-white">
      <div className="flex block-96 w-8 items-end justify-center rounded-lg bg-blue-500 pb-4 [writing-mode:sideways-lr]">block-96</div>
      <div className="flex block-80 w-8 items-end justify-center rounded-lg bg-blue-500 pb-4 [writing-mode:sideways-lr]">block-80</div>
      <div className="flex block-64 w-8 items-end justify-center rounded-lg bg-blue-500 pb-4 [writing-mode:sideways-lr]">block-64</div>
      <div className="flex block-48 w-8 items-end justify-center rounded-lg bg-blue-500 pb-4 [writing-mode:sideways-lr]">block-48</div>
      <div className="flex block-40 w-8 items-end justify-center rounded-lg bg-blue-500 pb-4 [writing-mode:sideways-lr]">block-40</div>
      <div className="flex block-32 w-8 items-end justify-center rounded-lg bg-blue-500 pb-4 [writing-mode:sideways-lr]">block-32</div>
      <div className="flex block-24 w-8 items-end justify-center rounded-lg bg-blue-500 pb-4 [writing-mode:sideways-lr]">block-24</div>
    </div>
  }
</Example>
...
<Example>
  {
    <div className="flex block-96 items-end justify-center space-x-4 font-mono text-xs font-bold text-white">
      <div className="relative flex block-full items-end">
        ...
        <div className="relative flex block-full w-8 items-end justify-center rounded-lg bg-sky-500 pb-6 [writing-mode:sideways-lr]">block-full</div>
      </div>
      <div className="relative flex block-full items-end">
        <Stripes border className="absolute inset-0 block-full rounded-lg" />
        <div className="relative flex block-9/10 w-8 items-end justify-center rounded-lg bg-sky-500 pb-6 [writing-mode:sideways-lr]">block-9/10</div>
      </div>
      <div className="relative flex block-full items-end">
        <Stripes border className="absolute inset-0 block-full rounded-lg" />
        <div className="relative flex block-3/4 w-8 items-end justify-center rounded-lg bg-sky-500 pb-6 [writing-mode:sideways-lr]">block-3/4</div>
      </div>
      <div className="relative flex block-full items-end">
        <Stripes border className="absolute inset-0 block-full rounded-lg" />
        <div className="relative flex block-1/2 w-8 items-end justify-center rounded-lg bg-sky-500 pb-6 [writing-mode:sideways-lr]">block-1/2</div>
      </div>
      <div className="relative flex block-full items-end">
        <Stripes border className="absolute inset-0 block-full rounded-lg" />
        <div className="relative flex block-1/3 w-8 items-end justify-center rounded-lg bg-sky-500 pb-6 [writing-mode:sideways-lr]">block-1/3</div>
      </div>
    </div>
  }
</Example>
