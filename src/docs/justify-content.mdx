...
<Example resizable>
  {
    <div className="grid grid-cols-1 gap-8">
      <div>
        <p className="font-mono text-xs font-medium text-gray-500 dark:text-gray-400">justify-center</p>
      ...
      <div>
        <p className="font-mono text-xs font-medium text-gray-500 dark:text-gray-400">justify-center-safe</p>
        <div className="mt-2 grid grid-cols-1">
          <Stripes border className="col-start-1 row-start-1 rounded-lg" />
...
<Example resizable>
  {
    <div className="grid grid-cols-1 gap-8">
      <div>
        <p className="font-mono text-xs font-medium text-gray-500 dark:text-gray-400">justify-end</p>
        <div className="mt-2 grid grid-cols-1">
          <Stripes border className="col-start-1 row-start-1 rounded-lg" />
      ...
      <div>
        <p className="font-mono text-xs font-medium text-gray-500 dark:text-gray-400">justify-end-safe</p>
        <div className="mt-2 grid grid-cols-1">
          <Stripes border className="col-start-1 row-start-1 rounded-lg" />
