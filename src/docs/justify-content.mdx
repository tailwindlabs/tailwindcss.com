...
Use `justify-center-safe` to justify items along the center of the container's main axis but allow them to align to the start of the container's main axis if there is not enough space:
...
<Example resizable>
  {
    <div className="mx-auto grid grid-cols-1">
      <Stripes border className="col-start-1 row-start-1 rounded-lg" />
      <div className="col-start-1 row-start-1 grid grid-flow-col justify-center-safe space-x-4 overflow-x-scroll rounded-lg font-mono text-sm leading-6 font-bold text-white">
        ...
        <div className="flex h-14 w-14 items-center justify-center rounded-lg bg-indigo-500">04</div>
      </div>
    </div>
  }
</Example>
...
Use `justify-end-safe` to justify items against the end of the container's main axis but allow them to align to the start of the container's main axis if there is not enough space:
...
<Example resizable>
  {
    <div className="mx-auto grid grid-cols-1">
      <Stripes border className="col-start-1 row-start-1 rounded-lg" />
      <div className="col-start-1 row-start-1 grid grid-flow-col justify-end-safe space-x-4 overflow-x-scroll rounded-lg font-mono text-sm leading-6 font-bold text-white">
        <div className="flex h-14 w-14 items-center justify-center rounded-lg bg-fuchsia-500">01</div>
        <div className="flex h-14 w-14 items-center justify-center rounded-lg bg-fuchsia-500">02</div>
        <div className="flex h-14 w-14 items-center justify-center rounded-lg bg-fuchsia-500">03</div>
        <div className="flex h-14 w-14 items-center justify-center rounded-lg bg-fuchsia-500">04</div>
      </div>
    </div>
