...
Learn more about how theme variables map to different utility classes in the [theme variable reference](#theme-variable-reference) documentation.
...
Learn more about how theme variables map to different utility classes and variants in the [theme variable reference](#theme-variable-reference) documentation.
