...
<div className="text-center font-mono text-sm font-medium text-gray-500 dark:text-gray-400">
  ...
  <div className="mx-5 mt-10">
    <div className="relative h-[3.625rem]">
      <div className="absolute top-0 left-[50%] -ml-3 flex h-12 flex-col items-center">
        <svg viewBox="0 0 32 34" className="w-7 flex-none text-white drop-shadow dark:stroke-white/10">
          <use href="#gradient-color-stop" />
        </svg>
        <div className="mt-2 h-2 w-0.5 bg-gray-900/30 dark:bg-white/30"></div>
      </div>
    ...
    <p className="mt-8">mask-luminance</p>
  </div>
</div>
...
<div class="mask-r-from-black mask-r-from-50% mask-r-to-transparent mask-alpha ..."></div>
<div class="mask-r-from-white mask-r-from-50% mask-r-to-black mask-luminance ..."></div>
```
