...
@layer theme { /* ... */}
/* prettier-ignore */
@layer base { /* Preflight styles here */ }
/* prettier-ignore */
@layer components { /* ... */ }
/* prettier-ignore */
@layer utilities { /* ... */ }
...
If you'd like to completely disable Preflight — perhaps because you're integrating Tailwind into an existing project or because you'd like to provide your own base styles — import the pieces of Tailwind that you need separately:
