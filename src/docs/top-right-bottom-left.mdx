...
<ResponsiveDesign
  properties={["inset", "inset-x", "inset-y", "inset-s", "inset-e", "inset-bs", "inset-be", "top", "left", "bottom", "right"]}
  defaultClass="top-4"
  featuredClass="top-6"
/>
...
<CustomizingYourSpacingScale
  utilities={["inset", "inset-x", "inset-y", "inset-s", "inset-e", "inset-bs", "inset-be", "top", "left", "bottom", "right"]}
/>
