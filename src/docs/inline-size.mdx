...
<Example>
  {
    <div className="flex justify-center">
      <div className="space-y-4 text-center font-mono text-xs font-bold text-white">
        <div className="hidden inline-96 rounded-lg bg-blue-500 px-4 py-2 sm:block">inline-96</div>
        <div className="hidden inline-80 rounded-lg bg-blue-500 px-4 py-2 sm:block">inline-80</div>
        <div className="hidden inline-64 rounded-lg bg-blue-500 px-4 py-2 sm:block">inline-64</div>
        <div className="inline-48 rounded-lg bg-blue-500 px-4 py-2">inline-48</div>
        <div className="inline-40 rounded-lg bg-blue-500 px-4 py-2">inline-40</div>
        <div className="inline-32 rounded-lg bg-blue-500 px-4 py-2">inline-32</div>
        <div className="inline-24 rounded-lg bg-blue-500 px-4 py-2">inline-24</div>
      </div>
    </div>
  }
</Example>
...
<div class="inline-24 ...">inline-24</div>
```
...
<Example>
  {
    <div className="space-y-4 font-mono text-xs font-bold text-white">
      <div className="flex gap-x-4">
        <div className="inline-1/2 rounded-lg bg-violet-500 px-4 py-2 text-center">inline-1/2</div>
        <div className="inline-1/2 rounded-lg bg-violet-500 px-4 py-2 text-center">inline-1/2</div>
      </div>
      <div className="flex gap-x-4">
        <div className="inline-2/5 rounded-lg bg-violet-500 px-4 py-2 text-center">inline-2/5</div>
        <div className="inline-3/5 rounded-lg bg-violet-500 px-4 py-2 text-center">inline-3/5</div>
      </div>
      <div className="flex gap-x-4">
        <div className="inline-1/3 rounded-lg bg-violet-500 px-4 py-2 text-center">inline-1/3</div>
        <div className="inline-2/3 rounded-lg bg-violet-500 px-4 py-2 text-center">inline-2/3</div>
      </div>
      <div className="inline-full rounded-lg bg-violet-500 px-4 py-2 text-center font-mono text-white">inline-full</div>
    </div>
  }
</Example>
...
<Example>
  {
    <div className="flex justify-center">
      <div className="space-y-4 text-center font-mono text-xs font-bold text-white">
        <div className="hidden inline-xl rounded-lg bg-sky-500 px-4 py-2 sm:block">inline-xl</div>
        <div className="hidden inline-lg rounded-lg bg-sky-500 px-4 py-2 sm:block">inline-lg</div>
        <div className="hidden inline-md rounded-lg bg-sky-500 px-4 py-2 sm:block">inline-md</div>
        <div className="inline-sm rounded-lg bg-sky-500 px-4 py-2">inline-sm</div>
        <div className="inline-xs rounded-lg bg-sky-500 px-4 py-2">inline-xs</div>
        <div className="inline-2xs rounded-lg bg-sky-500 px-4 py-2">inline-2xs</div>
        <div className="inline-3xs rounded-lg bg-sky-500 px-4 py-2">inline-3xs</div>
      </div>
    </div>
  }
</Example>
