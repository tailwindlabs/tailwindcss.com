...
<div>
  <div class="bg-sky-50/10"></div>
  <div class="bg-sky-100/20"></div>
  <div class="bg-sky-200/30"></div>
  <div class="bg-sky-300/40"></div>
  <div class="bg-sky-400/50"></div>
  <div class="bg-sky-500/60"></div>
  <div class="bg-sky-600/70"></div>
  <div class="bg-sky-700/80"></div>
  <div class="bg-sky-800/90"></div>
  <div class="bg-sky-900/100"></div>
</div>
```
...
Colors ate exposed as CSS variables in the `--color-*` namespace, so you can reference them in CSS with variables like `--color-blue-500` and `--color-pink-700`:
