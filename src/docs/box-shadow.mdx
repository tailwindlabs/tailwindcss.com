...
<Example padding={false}>
  {
    <div className="flex items-center justify-around gap-4 gap-y-6 bg-white px-6 py-14 font-mono font-bold max-sm:flex-col max-sm:py-10">
      ...
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500">shadow-xl/20</p>
        <div className="size-24 rounded-lg bg-white shadow-xl/20"></div>
      </div>
      <div className="flex shrink-0 flex-col items-center">
        <p className="mb-3 text-center font-mono text-sm font-medium text-gray-500">shadow-xl/30</p>
...
You can adjust the opacity of the inset shadow using an opacity modifier, like `inset-shadow-sm/30`.
