...
You can combine the following backdrop filter utilities: [blur](/docs/backdrop-blur), [brightness](/docs/backdrop-brightness), [contrast](/docs/backdrop-contrast), [grayscale](/docs/backdrop-grayscale), [hue-rotate](/docs/backdrop-hue-rotate), [invert](/docs/backdrop-invert), [opacity](/docs/backdrop-opacity), [saturate](/docs/backdrop-saturate), and [sepia](/docs/backdrop-sepia).
