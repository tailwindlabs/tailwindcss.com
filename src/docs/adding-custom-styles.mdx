...
Use the `@utility` directive to add custom utility:
...
You can now use this utility in your HTML, and it will also work with variants like `hover`, `focus` and `lg`:
...
This will match utilities like `tab-1`, `tab-4`, and `tab-github`.
