...
This will match utilities like `tab-1` and `tab-76`. For a comprehensive list on the available types you can check out the [MDN Docs on CSS types](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Types).
