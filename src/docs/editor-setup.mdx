...
Check out and download [Cursor](https://cursor.com/?utm_source=tailwind) – if you want your AI agent to be even better at writing Tailwind, become an [Insider](/sponsor) to get the Tailwind `Cursor.md` rules file.
