...
Tailwind CSS uses a lot of custom CSS syntax like `@theme`, `@variant`, and `@source`, and in many editors this can trigger warnings or errors where these rules aren't recognized.
...
- **Autocomplete**, providing intelligent suggestions for class names, as well as [CSS functions and directives](/docs/functions-and-directives).
- **Linting**, highlighting errors and potential bugs in both your CSS and your markup.
- **Hover previews**, revealing the complete CSS for a Tailwind class name when you hover over it.
...
It works seamlessly with custom Tailwind configurations, and because it’s just a
Prettier plugin, it works anywhere Prettier works — including every popular
editor and IDE, and of course on the command line.
