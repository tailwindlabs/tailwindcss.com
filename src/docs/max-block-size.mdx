...
<Example>
  {
    <div className="flex block-96 items-end justify-center space-x-4 text-center font-mono text-xs font-bold text-white">
      ...
      <div className="relative grid block-full w-8 items-end rounded-lg">
        <Stripes border className="absolute inset-0 block-full rounded-lg" />
        <div className="relative block-full max-block-24 w-full rounded-lg bg-blue-500">
          <div className="absolute bottom-6 w-8 -rotate-90 text-nowrap">max-block-24</div>
        </div>
      </div>
    </div>
  }
...
<Example>
  {
    <div className="flex block-96 items-end justify-center space-x-4 text-center font-mono text-xs font-bold text-white">
      <div className="relative grid block-full w-8 items-end rounded-lg">
        <Stripes border className="absolute inset-0 block-full rounded-lg" />
        <div className="relative block-full max-block-9/10 w-full rounded-lg bg-blue-500">
          <div className="absolute bottom-6 w-8 -rotate-90 text-nowrap">max-block-9/10</div>
        </div>
      </div>
      <div className="relative grid block-full w-8 items-end rounded-lg">
        <Stripes border className="absolute inset-0 block-full rounded-lg" />
        <div className="relative block-full max-block-3/4 w-full rounded-lg bg-blue-500">
          <div className="absolute bottom-6 w-8 -rotate-90 text-nowrap">max-block-3/4</div>
        </div>
      </div>
      <div className="relative grid block-full w-8 items-end rounded-lg">
        <Stripes border className="absolute inset-0 block-full rounded-lg" />
        <div className="relative block-full max-block-1/2 w-full rounded-lg bg-blue-500">
          <div className="absolute bottom-6 w-8 -rotate-90 text-nowrap">max-block-1/2</div>
        </div>
      </div>
      <div className="relative grid block-full w-8 items-end rounded-lg">
        <Stripes border className="absolute inset-0 block-full rounded-lg" />
        <div className="relative block-full max-block-1/4 w-full rounded-lg bg-blue-500">
          <div className="absolute bottom-6 w-8 -rotate-90 text-nowrap">max-block-1/4</div>
        </div>
      </div>
      <div className="relative grid block-full w-8 items-end rounded-lg">
        <Stripes border className="absolute inset-0 block-full rounded-lg" />
        <div className="relative block-full max-block-full w-full rounded-lg bg-blue-500">
