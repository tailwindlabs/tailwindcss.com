...
Style an input when it's valid, and the user has interacted with the form, using the `user-valid` variant:
...
Style an input when it's invalid, and the user has interacted with the form, using the `user-invalid` variant:
