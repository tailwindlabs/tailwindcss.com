...
Migrating from PostCSS is as simple as removing the postcss.config.js file and removing the autoprefixer, postcss, and the @tailwindcss/postcss package if it was added by the upgrade tool.
