...
Custom utilities must be a single class name in v4 and not a complex selector. If your custom utility is more complex than a single class name, use nesting to define the utility:
...
For more information see the [adding custom utilities documentation](/docs/adding-custom-styles#adding-custom-utilities).
