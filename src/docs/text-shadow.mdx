...
<div className="relative grid items-center justify-around gap-4 px-6 py-14 text-center text-2xl font-semibold text-white">
...
You can also adjust the opacity of the default shadow color using an opacity modifier. For example, `text-shadow-lg/20` is the equivalent of setting `text-shadow-lg` and `text-shadow-black/20` at the same time:
...
<div className="relative grid items-center justify-around gap-4 bg-gray-100 px-6 py-14 text-center text-2xl font-semibold text-white">
  <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1635776063328-153b13e3c245?q=80&w=3432&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-[size:150%_200%] bg-left opacity-75" />
  <p className="relative text-shadow-lg">The quick brown fox jumps over the lazy dog.</p>
