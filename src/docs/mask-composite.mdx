...
<div class="mask-add mask-[url(/img/circle.png),url(/img/circle.png)] bg-[url(/img/mountains.jpg)] mask-[position:30%_50%,70%_50%]"></div>
<div class="mask-subtract mask-[url(/img/circle.png),url(/img/circle.png)] bg-[url(/img/mountains.jpg)] mask-[position:30%_50%,70%_50%]"></div>
<div class="mask-intersect mask-[url(/img/circle.png),url(/img/circle.png)] bg-[url(/img/mountains.jpg)] mask-[position:30%_50%,70%_50%]"></div>
<div class="mask-exclude mask-[url(/img/circle.png),url(/img/circle.png)] bg-[url(/img/mountains.jpg)] mask-[position:30%_50%,70%_50%]"></div>
```
