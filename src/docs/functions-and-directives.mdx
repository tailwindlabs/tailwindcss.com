...
<Heading level="3" id="import-directive">@import</Heading>
...
<Heading level="3" id="theme-directive">@theme</Heading>
...
<Heading level="3" id="source-directive">@source</Heading>
...
<Heading level="3" id="utility-directive">@utility</Heading>
...
<Heading level="3" id="variant-directive">@variant</Heading>
...
<Heading level="3" id="custom-variant-directive">@custom-variant</Heading>
...
<Heading level="3" id="apply-directive">@apply</Heading>
...
<Heading level="3" id="reference-directive">@reference</Heading>
...
<Heading level="3" id="alpha-function">--alpha()</Heading>
...
<Heading level="3" id="spacing-function">--spacing()</Heading>
...
<Heading level="3" id="config-directive">@config</Heading>
...
<Heading level="3" id="plugin-directive">@plugin</Heading>
...
<Heading level="3" id="theme-function">theme()</Heading>
