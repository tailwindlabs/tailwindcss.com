...
Browsers vary in their interpretation of prettiness and may choose improvements like:
...
- Prioritizing different classes of soft wrap opportunities
- [and more…](https://drafts.csswg.org/css-text-4/#valdef-text-wrap-style-pretty)
