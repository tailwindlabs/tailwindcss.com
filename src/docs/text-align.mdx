...
<Example>
  {
    <div className="grid grid-cols-2 place-items-center gap-x-4">
      <div className="flex flex-col gap-y-4" dir="ltr">
        ...
        <div className="font-mono text-sm font-bold text-white text-start">start</div>
        <div className="font-mono text-sm font-bold text-white text-center">center</div>
        <div className="font-mono text-sm font-bold text-white text-end">end</div>
      </div>
