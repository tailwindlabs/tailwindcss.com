      ...
      <div className="@container grid grid-cols-1 grid-rows-[1fr_auto] lg:border-l lg:border-gray-950/5 dark:lg:border-white/10">
        <div className="flex items-center px-4 py-2 max-lg:line-y max-lg:mt-6 sm:px-2">
          <p className="max-w-2xl text-lg/7 font-medium text-pretty text-gray-600 dark:text-gray-400">
            Become a Tailwind CSS partner to support the project, get your brand in front of millions of developers, and
            get direct access to the Tailwind CSS team.
          </p>
        </div>
      ...
      <div className="relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2">
          <div className="line-y p-6 sm:p-8">
            <blockquote>
              <p className="text-base/7 font-medium text-pretty text-gray-600 italic dark:text-gray-300">
                "Working with the Tailwind team through the partner program was a game-changer for us. They helped us
                get custom utility classes we needed added to the framework, which saved our team months of
                workarounds."
              </p>
          ...
          <div className="line-y p-6 sm:p-8">
            <blockquote>
              <p className="text-base/7 font-medium text-pretty text-gray-600 italic dark:text-gray-300">
                "Having expedited access to the Tailwind CSS team means we can move faster without worrying about
                getting blocked by framework-level issues. The partner program pays for itself."
              </p>
              <footer className="mt-6 flex items-center gap-4">
                <div>
                  <p className="text-sm/6 font-semibold">Engineering Team</p>
      ...
      {sponsors.map((sponsor) => (
        ...
        >
          <a
            ...
            target="_blank"
            rel="noopener sponsored"
            className="grid grid-cols-[auto_1fr_auto] items-center gap-4 py-3 pr-4 pl-6 transition-colors hover:bg-gray-950/2.5 sm:grid-cols-[auto_1fr_auto_auto] sm:pr-2 sm:pl-4 dark:hover:bg-white/2.5"
          >
