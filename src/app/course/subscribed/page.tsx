    ...
    <div className="relative grid min-h-dvh grid-cols-1 place-items-center py-8 sm:px-0">
      <GridContainer className="grid gap-6 sm:grid-cols-[auto_1fr] md:gap-10">
        <div className="relative grid border-black/5 p-2 max-sm:justify-center max-sm:px-4 sm:border-r md:border-x dark:border-white/10">
          ...
          <Signature className="pointer-events-none absolute inset-x-0 -bottom-8 mx-auto fill-neutral-900 lg:-translate-x-1/5 dark:fill-neutral-200" />
        </div>
        <div className="grid content-center border-l border-black/5 md:border-x dark:border-white/10">
          ...
          <div className="mt-2 border-y border-black/5 p-2 max-sm:px-4 dark:border-white/10">
            <p className="font-mono text-sm font-medium text-neutral-700 uppercase max-sm:text-center dark:text-neutral-400">
              Tailwind CSS by Example
            </p>
            <h1 className="text-5xl tracking-tighter text-balance text-neutral-900 max-sm:text-center lg:text-8xl dark:text-white">
              Check your email.
            </h1>
          </div>
          <div className="mt-4 border-y border-black/5 p-2 max-md:border-b-0 max-sm:px-4 dark:border-white/10">
            <p className="max-w-xl text-lg/7 font-medium text-pretty text-neutral-500 max-sm:text-center dark:text-neutral-400">
              You should get a confirmation email any minute —{" "}
              <strong className="font-medium text-neutral-900 dark:text-white">open it up</strong> and{" "}
              <strong className="font-medium text-neutral-900 dark:text-white">confirm your email</strong> to make sure
              you're on the list.
            </p>
          </div>
        </div>
