  ...
  return (
    <>
      <div aria-hidden="true" className="absolute inset-x-0 top-0 left-1/5 -z-10 aspect-video opacity-50">
        ...
        <div className="absolute inset-0 size-full bg-linear-to-r from-neutral-950 to-75%"></div>
        <div className="absolute inset-0 size-full bg-linear-to-t from-neutral-950 to-50%"></div>
      </div>
      <GridContainer>
      ...
      <div className="mt-20 flex flex-col gap-4 sm:mt-24">
        <GridContainer>
          <p className="font-mono text-sm/6 tracking-wider text-neutral-400 uppercase">5-part mini-course</p>
          <h1 className="mt-2 text-5xl tracking-tighter text-balance text-white sm:text-8xl">
            Build UIs that don’t suck.
          </h1>
        </GridContainer>
        <GridContainer>
          <p className="max-w-2xl text-lg/7 font-medium text-neutral-400">
