...
Since it's the default value, you dont have to use the class, except for some specific cases, like for example: 

To undo a previusly explicitly specified width.
