...
```shell
npx tailwindcss-cli build ./src/tailwind.css -o ./dist/tailwind.css
```
...
```shell
npx tailwindcss-cli build ./src/tailwind.css -c ./.config/tailwind.config.js -o ./dist/tailwind.css
```
...
```shell
npx tailwindcss-cli build --no-autoprefixer -o tailwind.css
```
...
```shell
NODE_ENV=production npx tailwindcss-cli build ./src/tailwind.css -o ./dist/tailwind.css
```
