...
Tailwind 2.0 adds the 2xl breakpoint, which will mess up some uses of ``container``. In some cases, you may lose margins, causing layouts to fail. If this happens to you, remove the 2xl breakpoint.
```diff-js
// tailwind.config.js
module.exports = {
  purge: [
