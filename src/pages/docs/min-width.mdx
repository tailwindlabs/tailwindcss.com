...
The default spacing scale (i.e. `min-w-16`) is not included by default, but by defining the option as a function you can access the theme which lets you target other properties of the theme, `spacing` in this case.
