...
By defining the minWidth option as a function, you can access the theme function which lets you access other properties of the theme, for the default spacing scale.
