...
```html fuchsia
<template preview>
  <div class="w-full bg-fuchsia-300 h-96 bg-repeat" style="background-size: 12rem; background-image:url('/img/placeholder-fuchsia.svg');">
  </div>
</template>
...
```html rose
<template preview>
  <div class="w-full bg-rose-200 h-48 bg-center bg-no-repeat" style="background-size: 12rem; background-image:url('/img/placeholder-rose.svg');">
  </div>
</template>
...
```html purple
<template preview>
  <div class="w-full bg-purple-300 h-48 bg-center bg-repeat-x" style="background-size: 12rem; background-image:url('/img/placeholder-purple.svg');">
  </div>
</template>
...
```html indigo
<template preview>
  <div class="w-full bg-indigo-200 h-96 bg-center bg-repeat-y" style="background-size: 12rem; background-image:url('/img/placeholder-indigo.svg');">
  </div>
</template>
