...
Use `border-spacing` to control the spacing between the borders of cells. Note that this requires
the `border-separate` to be present.
...
```html
<table class="border-separate **border-spacing-2** border border-slate-400 ..." dark-class="border-collapse **border-spacing-2** border border-slate-500 ...">
  <thead>
    <tr>
...
<HoverFocusAndOtherStates element="table" featuredClass="border-spacing" />

### <Heading ignore>Breakpoints and media queries</Heading>

<BreakpointsAndMediaQueries element="table" featuredClass="border-spacing" />
