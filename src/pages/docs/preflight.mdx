...
## Images are contrained to the parent width
...
This, along with the above rules making them block-level, treats images and video as responsive by default. If you ever need to override this behavior you can do so by making one of these elements `max-w-none`.
