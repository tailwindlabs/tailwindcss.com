...
<p>Using the default configuration, the development build of Tailwind CSS is 3739.4kB uncompressed, 293.9kB minified and compressed with <a href="https://www.gnu.org/software/gzip/">Gzip</a>, and 73.2kB when compressed with <a href="https://github.com/google/brotli">Brotli</a>.</p>
...
<p>If you only need 3 screen sizes and 35 colors, you're down to 45.8kB compressed without changing anything else.</p>
