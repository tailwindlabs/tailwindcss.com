...
| --- | --- | --- |
| `border-s-*` | `border-l-*` | `border-r-*`
| `border-e-*` | `border-r-*` | `border-l-*`

### Using logical properties

<LogicalPropertyExample property="borderColor"/>

```html
<div class="grid border border-s-2 **border-s-indigo-400** border-slate-200 bg-white" dark-class="grid border border-s-2 **border-s-indigo-500** border-slate-700 ">
  <p>...</p>
