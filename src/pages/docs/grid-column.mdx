...
You can use only the col span value for making the entire column bigger.
<ArbitraryValues property="grid-column/grid-column-start/grid-column-end" featuredClass="col-[span_16]" />

Or you can use the start and end in the col span to give a more specific range to the width of the column.
