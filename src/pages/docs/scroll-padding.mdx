...
```html
<div class="bg-white **scroll-ps-12** snap-x overflow-x-auto grid grid-flow-col gap-12 py-4 ps-12 pe-96" dark-class="bg-slate-900 **scroll-ps-12** snap-x overflow-x-auto grid grid-flow-col gap-12 py-4 ps-12 pe-96">
  <div class="snap-start">
