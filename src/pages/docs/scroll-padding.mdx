...
Here are all the available scroll padding logical property utilities and their physical property equivalents in both LTR and RTL modes.

| Class | Left-to-right | Right-to-left |
| --- | --- | --- |
| `scroll-ps-*` | `scroll-pl-*` | `scroll-pr-*` |
| `scroll-pe-*` | `scroll-pr-*` | `scroll-pl-*` |
