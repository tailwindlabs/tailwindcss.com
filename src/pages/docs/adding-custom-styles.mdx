...
Any custom class you add to the `components` or `utilities` layers will only be included in your compiled CSS if those class names are actually used in your HTML. Style rules without class names will always be included.
