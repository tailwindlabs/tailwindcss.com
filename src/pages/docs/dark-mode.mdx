...
The darkMode `class` strategy requires a `.dark` class on the `html` tag, you can also customize
this class using a tuple with the strategy of class and the preferred class.
