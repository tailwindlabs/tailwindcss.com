...
<UsingLogicalProperties feature="Scroll margin" syntax="scroll-m{s|e}-{size}" />
...
Here are all the available scroll margin logical property utilities and their physical property equivalents in both LTR and RTL modes.

| Class | Left-to-right | Right-to-left |
| --- | --- | --- |
| `scroll-ms-*` | `scroll-ml-*` | `scroll-mr-*` |
| `scroll-me-*` | `scroll-mr-*` | `scroll-ml-*` |

```html
<div class="bg-white snap-x overflow-x-auto grid grid-flow-col gap-12 py-4 ps-6" dark-class="bg-slate-900 snap-x overflow-x-auto grid grid-flow-col gap-12 py-4 ps-6">
  <div class="snap-start **scroll-ms-6**">
    <img src='...product-01.jpg'/>
    <div class="mt-2 flex justify-between">
      <h3 class="text-slate-700" dark-class="text-slate-300">...</h3>
      <p class="text-slate-900" dark-class="text-slate-50">...</p>
    </div>
  </div>
  ...
</div>
