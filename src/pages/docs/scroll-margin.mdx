...
<LogicalPropertyExample property="scrollMargin"/>

Images courtesy of [Ugmonk](https://ugmonk.com)

```html
<div class="bg-white snap-x overflow-x-auto grid grid-flow-col gap-12 py-4 ps-6 pe-72" dark-class="bg-slate-900 snap-x overflow-x-auto grid grid-flow-col gap-12 py-4 ps-6 pe-72">
