...
You can save time by adding tailwind automatically. After creating a Angular project running the `ng new my-project` command, in your project folder, run the following command:
