...
If you want to add smaller custom breakpoints, the best approach is the following: 
...
Notice that the default screens are added after the custom breakpoint. That's because if you add a smaller breakpoint than the default ones, it can override them. So in order to solve this problem you need to add the default breakpoint after your smaller custom breakpoints.
