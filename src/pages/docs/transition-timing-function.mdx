...
<template preview>
  <div class="flex justify-around items-center">
    <button class="transition duration-700 ease-linear transform hover:scale-125 bg-indigo-600 text-white font-semibold py-3 px-6 rounded-md">
      Hover me
    </button>
...
<button class="transition **ease-linear** duration-700 ...">Hover me</button>
