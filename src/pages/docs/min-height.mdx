...
The default spacing scale (i.e. `min-h-16`) is not included by default, but by defining the minWidth option as a function, you can access the theme function which lets you access other properties of the theme.
