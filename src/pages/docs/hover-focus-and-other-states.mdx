...
```html {{ mode: 'example', hint: 'Hover over this button to see the background color change' }}
...
```html {{ mode: 'example', hint: 'Try interacting with this button to see the hover, focus, and active states' }}
<div class="grid place-items-center">
...
```html {{ mode: 'example', p: 'none', hint: 'Try making the email address valid to see the styles change' }}
...
```html {{ mode: 'example', hint: 'Hover over the card to see both text elements change color' }}
...
```html {{ mode: 'example', p: 'none', hint: 'Try making the email address valid to see the warning disappear' }}
...
```html {{ mode: 'example', p: 'none', hint: 'Try selecting some of this text with your mouse' }}
<div class="px-6">
...
```html {{ mode: 'example', hint: 'Try emulating &#96;prefers-reduced-motion: reduce&#96; in your developer tools to hide the spinner' }}
...
```html {{ mode: 'example', hint: 'Try toggling the disclosure to see the styles change' }}
