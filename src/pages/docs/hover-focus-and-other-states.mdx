...
When you need to add the same style to every direct child of an element, you can use the `*` modifier.

```html {{ example: { p: 'none' } }}
<div class="max-w-md mx-auto bg-white shadow pt-6 pb-5 px-6 ">
  <h4 class="pl-1 text-slate-700">Categories:<h4>
  <div class="flex flex-wrap gap-x-2 gap-y-3 pt-4 text-sm text-indigo-600 *:cursor-pointer *:rounded-full *:border *:border-indigo-100 *:bg-indigo-50 *:px-2 *:py-0.5 hover:*:border-indigo-600 hover:*:bg-indigo-500 hover:*:text-indigo-50">
    <div>Sales</div>
    <div>Marketing</div>
    <div>SEO</div>
    <div>Analytics</div>
...
<div>
  <h4>Categories:<h4>
  <div class="***:rounded-full *:border *:border-indigo-100 *:bg-indigo-50 *:px-2 *:py-0.5 hover:*:border-indigo-600 hover:*:bg-indigo-500 hover:*:text-indigo-50**">
    <div>Sales</div>
    <div>Marketing</div>
    <!-- ... -->
  </div>
...
It's important to note that overriding a style with a utility directly on the child itself won't work due to the specificity of the generated selector.

<TipBad>Won't work, children can't override their own styling.</TipBad>

```html
<div class="*:bg-indigo-50 **hover:*:border-indigo-600** ...">
  <div class="**hover:bg-red-500**">Sales</div>
  <div>Marketing</div>
  <!-- ... -->
</div>
```
...
Use the `has-*` modifier to style an element based on the state or content of it's descendants.


```html {{ example: { p: 'none' } }}
<div class=' max-w-md mx-auto bg-white shadow py-6 px-4'>
  <fieldset class="grid w-full items-start gap-1">
    <legend class='text-slate-500 mb-4'>Select   payment method:</legend>
    <label for="apple-1" class="text-slate-700 has-[:checked]:ring-indigo-500  has-[:checked]:bg-indigo-50 grid h-[64px] grid-cols-[24px_1fr_auto] items-center gap-6 rounded-lg px-4 ring-1 ring-transparent hover:bg-slate-100">
      <svg class="w-8 fill-slate-500" viewBox="0 0 24 13">
...
```
You can use `has-*` with a pseudo-class modifier, like `has-[:focus]`, to detect state changes in descendants but you can also use element selectors, like `has-[img]` or `has-[a]`, to style an element based on the _content_ of it's descendants.
...
```html {{ example: { p: 'none' } }}
<div class=' max-w-md mx-auto bg-white shadow  grid  divide-y divide-slate-100 text-slate-700'>
  <div class="has-[a]:hover:bg-slate-50 group grid grid-cols-[32px_1fr_auto] pt-6 items-center gap-x-4 px-4 py-4">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="size-4 group-has-[a]:block hidden group-hover:text-blue-600">
      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" />
    </svg>
    <p class="col-start-2 text-sm">Product Designer at <a class="text-blue-500 underline">planeteria.tech</a></p>
  </div>
  <div class="has-[a]:hover:bg-slate-50 group grid grid-cols-[32px_1fr_auto] items-center gap-x-4 px-4 py-4">
  ...
  <div class="has-[a]:hover:bg-slate-50 group grid grid-cols-[32px_1fr_auto] items-center gap-x-4 px-4 py-4">
    ...
    <p class="col-start-2 text-sm">A multidisciplinary designer, working at the intersection of art and technology.<br/><a class="text-blue-500 underline">alex-reed.com</a> </p>
  </div>
  <div class="has-[a]:hover:bg-slate-50 group grid grid-cols-[32px_1fr_auto] items-center pb-6 gap-x-4 px-4 py-4">
...
<div class="**group** ... ">
  ...
  <h4 class="font-semibold text-slate-900">Spencer Sharp</h4>
  <svg class="hidden **group-has-[a]:block** group-hover:text-blue-600">
    ...
  </svg>
  <p class="text-sm">Product Designer at <a class="text-blue-500 underline">planeteria.tech</a></p>
</div>
```
...
<div class=' max-w-md mx-auto bg-white shadow py-6 px-4'>
  <fieldset>
    ...
    <div class="grid grid-cols-[1fr_24px] items-center gap-6 pt-3">
      <div class="peer grid grid-cols-[auto_1fr] items-center gap-3 rounded-md px-2 hover:bg-slate-100">
        <input class="peer size-3.5 appearance-none rounded-sm border border-slate-300 accent-pink-500 dark:accent-pink-600 checked:appearance-auto" id="item_1" checked type="checkbox" />
        <label for="item_1" class="select-none text-slate-700 peer-checked:text-slate-400 peer-checked:line-through">Create a to do list</label>
      </div>
    ...
    <div class="grid grid-cols-[1fr_24px] items-center gap-6 pt-3">
      <div class="peer grid grid-cols-[auto_1fr] items-center gap-3 rounded-md px-2 hover:bg-slate-100">
        <input class="peer size-3.5 appearance-none rounded-sm border border-slate-300 accent-pink-500 dark:accent-pink-600 checked:appearance-auto" id="item_2" type="checkbox" />
        <label for="item_2" class="select-none text-slate-700 peer-checked:text-slate-400 peer-checked:line-through">Check off first item</label>
      </div>
      <div class="size-[26px] rounded-md p-1 hover:bg-red-50 hover:text-red-500 peer-has-[:checked]:hidden">
        <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
    ...
    <div class="grid grid-cols-[1fr_24px] items-center gap-6 pt-3">
      <div class="peer grid grid-cols-[auto_1fr] items-center gap-3 rounded-md px-2 hover:bg-slate-100">
        <input class="peer size-3.5 appearance-none rounded-sm border border-slate-300 accent-pink-500 dark:accent-pink-600 checked:appearance-auto" id="item_3"  type="checkbox" />
        <label for="item_3" class="select-none text-slate-700 peer-checked:text-slate-400 peer-checked:line-through">Investigate race condition</label>
      </div>
...
<fieldset>
  ...
  <div class="peer ...">
    ...
    <label for="item_1">Create a to do list</label>
  </div>
  <div class="block **peer-has-[:checked]:hidden** ...">
    <svg>
      <!-- ... -->
    </svg>
  </div>
