...
JetBrains IDEs like WebStorm, PhpStorm, and others include support for intelligent Tailwind CSS completions in your JS, CSS when using `@apply`, Vue, HTML, and other template languages like PHP and Ruby (ERB helpers).

Make sure the [Tailwind CSS plugin](https://plugins.jetbrains.com/plugin/15321-tailwind-css) is installed and enabled in _Preferences / Settings | Plugins_.

<img src={require('@/img/jb-plugin.png').default} alt="JetBrains Tailwind CSS plugin" width={1344} height={672} className="rounded-lg" />

To learn more about Tailwind CSS support in WebStorm and other JetBrains IDEs, check out [WebStorm online help](https://www.jetbrains.com/help/webstorm/tailwind-css.html).
