...
Emacs does not support Tailwind CSS Completions out of the box but it can be added easily.
Install the [lsp-tailwindcss](https://github.com/merrickluo/lsp-tailwindcss) package from [MELPA](http://melpa.org/) and then `M-x lsp-install-server` and select tailwindcss.
