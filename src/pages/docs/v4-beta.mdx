...
<div class="py-4 grid">
  <div class="relative w-full max-w-96 justify-self-center">
    ...
    <div class="mt-2">
      <textarea placeholder="Write something..." name="comment" id="comment" class="block w-full resize-none rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 [field-sizing:content] dark:text-gray-100 placeholder:dark:text-gray-600"></textarea>
    </div>
  </div>
</div>
```
...
<div class="flex flex-col gap-8">
  ...
  <div>
    <span class="font-medium text-sm text-slate-500 font-mono mb-3 dark:text-slate-400">font-stretch-extra-regular</span>
