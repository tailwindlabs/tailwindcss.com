...
<div class="mx-auto max-w-sm overflow-clip rounded-lg bg-white shadow">
  <div class="aspect-h-3 aspect-w-3 overflow-hidden">
    <img src="https://tailwindui.com/plus/img/ecommerce-images/shopping-cart-page-01-product-02.jpg" alt="Two each of gray, white, and black shirts laying flat." class="h-full w-full object-cover object-center" />
  </div>
