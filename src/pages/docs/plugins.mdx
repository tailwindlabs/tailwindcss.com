...
The `@tailwindcss/container-queries` plugin adds a set of `@{size}` classes that makes it easier to style elements using container queries instead of media queries.
