...
### Using logical properties
 ...
 Margin can be controlled with [logical properties](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Logical_Properties) which is useful when supporting multi-directional layouts. Currently, this is only supported in the inline direction:
