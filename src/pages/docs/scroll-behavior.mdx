...
<HoverFocusAndOtherStates defaultClass="scroll-smooth" featuredClass="scroll-auto" />

### <Heading ignore>Breakpoints and media queries</Heading>

<BreakpointsAndMediaQueries defaultClass="scroll-smooth" featuredClass="scroll-auto" />
