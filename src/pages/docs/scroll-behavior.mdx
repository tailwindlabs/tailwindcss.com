...
<Example>
  <button onClick={(e) => document.getElementById('testing').scrollIntoView({ block: 'nearest' })}>click</button>
</Example>

<div className="relative h-40 overflow-y-auto scroll-smooth   bg-gray-100 p-4 border rounded not-prose">
