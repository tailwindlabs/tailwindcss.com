...
`@apply` used  `Arbitrary values`.

<TipBad>Won't work, Less  doesn't understand our syntax there.</TipBad>
...
<TipGood>Use the escaping syntax to make sure Less doesn't try to parse that code.</TipGood>
