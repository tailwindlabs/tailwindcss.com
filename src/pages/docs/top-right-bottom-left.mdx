...
<UsingLogicalProperties feature="Position" syntax="{start|end}-{size}" />
...
Here are all the available position logical property utilities and their physical property equivalents in both LTR and RTL modes.
