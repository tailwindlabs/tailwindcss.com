...
export const meta = {
  ...
  salary: "$275,000 USD",
  applyUrl: "https://www.workable.com/",
  ...
  dateCloses: '2024-04-02T01:00:00.000Z',
  image: card,
}
...
<p className="lead">This is a fully remote position with a salary of $275,000 USD, open to candidates in the Eastern (UTC-5) to Central European (UTC+1) timezones. We’re accepting applications until Monday April 1st at 9:00pm ET.</p>
...
- **Redesign and build [Headless UI documentation site](https://twitter.com/steveschoger/status/1745816291351425068)** — rethinking the overall branding and making the site feel more modern and consistent.
