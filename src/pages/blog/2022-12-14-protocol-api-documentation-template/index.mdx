...
<div className="my-8">
  <a href="https://tailwindui.com/templates/protocol">
    <img src={home.src} alt="Learn about the Protocol template"/>
  </a>
</div>
...
<div className="relative rounded-lg overflow-hidden">
  ...
  <video src="https://assets.tailwindcss.com/blog/2022-12-14-protocol-api-documentation-template/sticky-code-blocks.mp4" autoPlay playsInline loop muted className="block m-0" />
</div>
...
<div className="relative rounded-lg overflow-hidden">
  <div className="absolute inset-0 rounded-lg ring-1 ring-inset ring-slate-900/10 pointer-events-none"></div>
  <video src="https://assets.tailwindcss.com/blog/2022-12-14-protocol-api-documentation-template/hovering-cards.mp4" autoPlay playsInline loop muted className="block m-0" />
</div>
...
<div className="relative rounded-lg overflow-hidden">
  <div className="absolute inset-0 rounded-lg ring-1 ring-inset ring-slate-900/10 pointer-events-none"></div>
  <video src="https://assets.tailwindcss.com/blog/2022-12-14-protocol-api-documentation-template/animated-sidebar.mp4" autoPlay playsInline loop muted className="block m-0" />
</div>
...
<div className="my-8">
  <img src={documentation.src} alt="Example of generated documentation from MDX source"/>
</div>
...
<div className="my-8">
  <img src={darkmode.src} alt=""/>
</div>

The dark mode version has lots of its own cool design details too — I love different primary button treatment for instance.
...
<div className="my-8">
  <img src={commandPalette.src} alt=""/>
</div>
