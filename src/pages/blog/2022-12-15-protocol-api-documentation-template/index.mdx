...
<div className="my-8">
  <img src={texture.src} alt="The illustrated background pattern included in this template" />
</div>
...
<div className="my-8">
  <img src={icons.src} alt="The 28 icons included with this template" />
</div>
...
<div className="my-8">
  <img src={convertkit.src} alt="The Protocol template adapted for ConvertKit" />
</div>
...
<div className="my-8">
  <img src={darkmode.src} alt="The Protocol template with dark mode enabled" />
</div>
