...
- **Explicit content path configuration** — making it possible to tell Tailwind exactly where you templates are when automatic content detection isn't good enough for your setup.
...
If you're using the Tailwind CSS IntelliSense extension for VS Code, make sure you switch the prerelease version from the extension page, and if you're using our Prettier plugin, make sure you install the latest version.
