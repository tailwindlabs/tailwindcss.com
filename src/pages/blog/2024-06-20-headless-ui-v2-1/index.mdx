...
We've already gone ahead an updated all of Tailwind UI to use this new transition API. Here's a few categories specifically that include transitions:

- [Modal Dialog components](https://tailwindui.com/components/application-ui/overlays/modal-dialogs)
- [Dropdown components](https://tailwindui.com/components/application-ui/elements/dropdowns)
- [Slide-over components](https://tailwindui.com/components/application-ui/overlays/slide-overs)
- [Flyout Menu components](https://tailwindui.com/components/marketing/elements/flyout-menus)
- [Select Menu components](https://tailwindui.com/components/application-ui/forms/select-menus)
