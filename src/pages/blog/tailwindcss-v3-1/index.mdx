...
```html {{ mode: 'example', p: 'none', hint: 'Scroll this table to see the sticky header row in action' }}
...
```html {{ mode: 'example', p: 'none', hint: 'Try emulating &#96;prefers-contrast: more&#96; in your developer tools to see the changes' }}
...
```html {{ mode: 'example', p: 'none', hint: 'Try hovering over the text &ldquo;Floyd Miles&rdquo;' }}
<div class="px-4 py-6">
  <div class="max-w-md mx-auto">
