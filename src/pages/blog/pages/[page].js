...
import Post1 from '../2024-05-24-catalyst-application-layouts/index.mdx'
import Post2 from '../headless-ui-v2/index.mdx'
import Post3 from '../hiring-a-design-engineer-and-staff-engineer/index.mdx'
import Post4 from '../tailwindcss-v4-alpha/index.mdx'
import Post5 from '../introducing-catalyst/index.mdx'
...
export default function Blog({}) {
  ...
  let pagePosts = posts.slice((page - 1) * 3, page * 3)
    ...
    <main className="max-w-[52rem] mx-auto px-4 pb-28 sm:px-6 md:px-8 xl:px-12 lg:max-w-6xl">
      ...
      <div className="relative sm:pb-12 sm:ml-[calc(2rem+1px)] md:ml-[calc(3.5rem+1px)] lg:ml-[max(calc(14.5rem+1px),calc(100%-48rem))]">
        ...
        <div className="space-y-16">
          {pagePosts.map((Post) => (
            <article key={Post.layoutProps.slug} className="relative group">
              ...
              >
                ...
                <span className="relative">
                  Read more<span className="sr-only">, {Post.layoutProps.meta.title}</span>
                </span>
                <svg
