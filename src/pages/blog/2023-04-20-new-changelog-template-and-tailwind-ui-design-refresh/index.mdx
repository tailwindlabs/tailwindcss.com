...
<div className="my-8">
  <a href="https://tailwindui.com/templates/commit">
    <img src={commitTemplate.src} alt="Learn about the Commit template"/>
  </a>
</div>
...
<div className="my-8">
  <img src={commitTemplateDarkMode.src} alt="The Commit template in dark mode, partially scrolled down to reveal a second post."/>
</div>
...
<div className="my-8">
  <img src={commitTemplateForMotionOne.src} alt="The Commit template customized to match the branding of the Motion One open-source library."/>
</div>
...
<div className="my-8">
  <img src={tailwindUiRefresh.src} alt=""/>
</div>
...
### Redesigned components that felt out of date


<div className="my-8">
  <img src={tailwindUiRedesignedComponents.src} alt=""/>
</div>


### Made subtle improvements across the board
...
<div className="my-8">
  <img src={tailwindUiSubtleImprovements.src} alt="A collage of redesigned marketing components for Tailwind UI."/>
</div>
...
- Simplified and cleaned up examples (more white, less cards, less color)

Ullam tenetur doloribus aut consequuntur distinctio magnam facilis. Blanditiis est animi totam repellendus at exercitationem iste nam.

### Added a bunch of brand new examples

<div className="my-8">
  <img src={tailwindUiNewComponents.src} alt=""/>
</div>


- New testimonials in cards

### More dark examples

<div className="my-8">
  <img src={tailwindUiDarkComponents.src} alt=""/>
</div>
...
<div className="my-8">
  <img src={tailwindUiNewPageExamples.src} alt=""/>
</div>
