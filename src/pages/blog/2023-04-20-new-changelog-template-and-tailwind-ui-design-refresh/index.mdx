...
Check out the updated [Home Screens](https://tailwindui.com/components/application-ui/page-examples/home-screens) category for a few new designs.

---

Finally some paragraph to finish the blog post so I can just publish it and be done with this far too damn time-consuming project.