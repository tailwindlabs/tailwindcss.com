...
<div className="my-8">
  <img src={tailwindUiRefresh.src} alt="A collage of redesigned page examples and components for Tailwind UI"/>
</div>
...
<div className="my-8">
  <img src={tailwindUiRedesignedComponents.src} alt="A comparison between an old component in Tailwind UI and it’s new redesigned version"/>
</div>
...
<div className="my-8">
  <img src={tailwindUiSubtleImprovements.src} alt="A comparison between an old component in Tailwind UI and it’s new fine-tuned version"/>
</div>
...
<div className="my-8">
  <img src={tailwindUiNewComponents.src} alt="A collage of new component examples in Tailwind UI"/>
</div>
...
<div className="my-8">
  <img src={tailwindUiDarkComponents.src} alt="A collage of new dark component examples in Tailwind UI"/>
</div>
...
<div className="my-8">
  <img src={tailwindUiNewPageExamples.src} alt="A collage of new page examples in Tailwind UI"/>
</div>
