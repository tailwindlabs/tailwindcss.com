...
import protocolPreview from './protocol-preview.jpg'
import documentationExampleScreenshot from './documentation-example-screenshot.png'
...
<div className="my-8">
  <a href="https://tailwindui.com/templates/protocol">
    <img src={protocolPreview.src} alt="Learn about the Protocol template"/>
  </a>
</div>
...
**Insert screen recording of the sticky code blocks**
...
**Insert screen recording of moving mouse cursor around on cards**
...
**Insert screen recording of how the sidebar works**
...
<div className="my-8">
    <img src={documentationExampleScreenshot.src} alt="Example of generated documentation from MDX source"/>
</div>

**Might need a better screenshot here, up to you guys.**
...
**Insert image showing off background pattern**
...
**Insert screenshot of ConvertKit version**
...
**Insert screenshot or video of command palette**
