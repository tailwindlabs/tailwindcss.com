...
<h2 id="multiple-config-files-in-one-project-using-config">Multiple config files in one project using @config</h2>
...
<h2 id="browser-support-based-styling-with-supports">Browser-support-based styling with supports-*</h2>
...
<h2 id="dynamic-group-and-peer-variants">Dynamic group-* and peer-* variants</h2>
...
<h2 id="dynamic-variants-with-matchvariant">Dynamic variants with matchVariant</h2>
...
For some more information read about [dynamic variants](/docs/plugins#dynamic-utilities) in our plugin documentation.

---


<h2 id="nested-group-and-multiple-peer-support-using-variant-modifiers">Nested group and multiple peer support using variant modifiers</h2>
