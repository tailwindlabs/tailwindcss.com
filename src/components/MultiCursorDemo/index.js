        ...
        <div className="sm:px-8 flex sm:justify-center">
          <div className="bg-white px-6 py-4 shadow">
            <nav className="flex justify-center space-x-4">
              <Link legacyBehavior href="#/dashboard" className={linkClassName}>
                Home
              </Link>
              <Link legacyBehavior href="#/team" className={linkClassName}>
                Team
              </Link>
              <Link legacyBehavior href="#/projects" className={linkClassName}>
                Projects
              </Link>
              <Link legacyBehavior href="#/reports" className={linkClassName}>
                Reports
              </Link>
            </nav>
          </div>
