      ...
      <GridContainer className="mt-10">
        <div className="px-2 max-sm:px-4">
          <a
            ...
            className="inline-block rounded-4xl bg-black px-4 py-2 text-sm/6 font-semibold text-white hover:bg-neutral-800 dark:bg-neutral-700 dark:hover:bg-neutral-600"
          >
      ...
      <TabGroup>
        <GridContainer className="mt-16">
          <div className="mt-16 grid w-full overflow-x-hidden">
            <TabList className="grid grid-cols-[repeat(3,_minmax(125px,_1fr))] divide-x divide-neutral-950/10 overflow-x-auto text-neutral-950 dark:divide-white/10 dark:text-white">
              <TabButton className="data-selected:bg-pink-500/5 data-selected:text-pink-600 dark:data-selected:text-pink-500">
                ...
                <div className="text-center xl:text-left">
                  ...
                  <p className="mt-2 hidden text-sm text-neutral-600 lg:block dark:text-neutral-400">
        ...
        <GridContainer className="mt-4">
          <TabPanels>
            <TabPanel className="bg-neutral-950/5 p-2 dark:bg-white/10 dark:opacity-40">
              <BentoItem className="relative isolate h-148 w-full overflow-hidden bg-white/75! p-0! dark:bg-neutral-950! dark:ring dark:ring-white/10">
            ...
            <TabPanel className="bg-neutral-950/5 p-2 dark:bg-white/5">
              <BentoItem className="relative isolate h-148 w-full overflow-hidden bg-white/75! p-0! dark:bg-neutral-950!">
                  ...
                  <div className="relative top-(--top,0) right-(--right,54%) grid size-full origin-top-left rotate-x-55 rotate-y-0 -rotate-z-45 grid-cols-4 gap-8 transform-3d">
                    ...
                    >
                      <img
                        ...
                        className="aspect-970/580 ring ring-neutral-950/5 dark:hidden"
                        width={970}
                        height={580}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/580 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={970}
                        height={580}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-971/582 ring ring-neutral-950/5 dark:hidden"
                        width={971}
                        height={582}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-971/582 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={971}
                        height={582}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-971/820 ring ring-neutral-950/5 dark:hidden"
                        width={971}
                        height={820}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-971/820 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={971}
                        height={820}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/508 ring ring-neutral-950/5 dark:hidden"
                        width={970}
                        height={508}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/508 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={970}
                        height={508}
                        alt=""
                      />
                    ...
                    >
                      <img
                        ...
                        className="aspect-970/436 ring ring-neutral-950/5 dark:hidden"
                        width={970}
                        height={436}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/436 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={970}
                        height={436}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/700 ring ring-neutral-950/5 dark:hidden"
                        width={970}
                        height={700}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/700 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={970}
                        height={700}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-971/879 ring ring-neutral-950/5 dark:hidden"
                        width={971}
                        height={879}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-971/879 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={971}
                        height={879}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/557 ring ring-neutral-950/5 dark:hidden"
                        width={970}
                        height={557}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/557 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={970}
                        height={557}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/763 ring ring-neutral-950/5 dark:hidden"
                        width={970}
                        height={763}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/763 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={970}
                        height={763}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/922 ring ring-neutral-950/5 dark:hidden"
                        width={970}
                        height={922}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/922 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={970}
                        height={922}
                        alt=""
                      />
                    ...
                    >
                      ...
                      <img
                        ...
                        className="aspect-971/395 ring ring-neutral-950/5 dark:hidden"
                        width={971}
                        height={395}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-971/395 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={971}
                        height={395}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-971/349 ring ring-neutral-950/5 dark:hidden"
                        width={971}
                        height={349}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-971/349 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={971}
                        height={349}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/975 ring ring-neutral-950/5 dark:hidden"
                        width={970}
                        height={975}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/975 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={970}
                        height={975}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/381 ring ring-neutral-950/5 dark:hidden"
                        width={970}
                        height={381}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/381 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={970}
                        height={381}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/782 ring ring-neutral-950/5 dark:hidden"
                        width={970}
                        height={782}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/782 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={970}
                        height={782}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/426 ring ring-neutral-950/5 dark:hidden"
                        width={970}
                        height={426}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/426 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={970}
                        height={426}
                        alt=""
                      />
                    ...
                    >
                      <img
                        ...
                        className="aspect-970/600 ring ring-neutral-950/5 dark:hidden"
                        width={970}
                        height={600}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-970/600 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={970}
                        height={600}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-972/854 ring ring-neutral-950/5 dark:hidden"
                        width={972}
                        height={854}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-972/854 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={972}
                        height={854}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-971/725 ring ring-neutral-950/5 dark:hidden"
                        width={971}
                        height={725}
                        alt=""
                      />
                      <img
                        ...
                        className="aspect-971/725 ring ring-neutral-950/5 dark:ring-white/10 not-dark:hidden"
                        width={971}
                        height={725}
                        alt=""
                      />
                ...
                <div className="absolute -left-[300%] h-150 w-380 min-[500px]:-left-[250%] sm:-left-[200%] md:-left-[150%] lg:-left-[100%] xl:-left-[80%] 2xl:-left-[65%]">
                  <div className="flex origin-top-left scale-100 rotate-x-55 rotate-y-0 -rotate-z-45 grid-cols-3 flex-row gap-4 transform-3d dark:bg-white/5">
                    <motion.img
                      ...
                      src={uiKitCol1.src}
                      className="ring ring-neutral-950/5 dark:hidden"
                      width={399}
                      height={2019.5}
                      alt=""
                    />
