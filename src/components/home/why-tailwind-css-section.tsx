...
export default function WhyTailwindCssSection() {
  return (
    <div className="relative max-w-full">
      <div className="invisible h-4 max-w-screen items-end px-2 font-mono text-xs/6 whitespace-pre text-black/10 max-sm:px-4 2xl:visible 2xl:flex dark:text-white/15">
      ...
      <GridContainer className="mt-16">
        <div className="grid w-full grid-flow-dense grid-cols-6 gap-2 bg-gray-950/5 p-2 dark:bg-white/10">
          ...
          <BentoItem className="col-span-full xl:col-span-3">
            <BentoHeader>
              ...
              <div>
                ...
                <BentoDescription>
                  No one likes messing around with easing curves and you don’t have to—just pick a transition or
                  animation preset.
                </BentoDescription>
              </div>
            </BentoHeader>
                ...
                <div className="flex h-full flex-1 flex-col items-center justify-between p-6">
                  <div className="mt-7 flex w-full flex-1 items-center justify-center">
                    <div className="flex items-center justify-center">
                      <button
                        type="button"
                        className="inline-flex cursor-not-allowed items-center rounded-md bg-sky-500 px-4 py-2 text-sm leading-6 font-semibold text-white shadow transition duration-150 ease-in-out hover:bg-sky-400"
                        disabled
                      >
                        <svg
                  ...
                  <div className="mt-7 flex w-full flex-1 items-center justify-center">
                    <div className="flex items-center justify-center">
                      <span className="relative inline-flex">
                        <button
                          type="button"
                          className="inline-flex cursor-not-allowed items-center rounded-lg bg-white p-2 text-gray-400 ring shadow-xs ring-gray-950/5 transition duration-150 ease-in-out dark:bg-gray-700 dark:ring-white/10"
                          disabled
                        >
                ...
                <div className="flex h-full flex-1 flex-col items-center justify-between p-6">
                  <div className="mt-7 flex w-full flex-1 items-center justify-center">
                    <div className="flex flex-1 items-center justify-center">
                      <div className="h-20 w-full max-w-xs rounded-lg bg-white p-4 ring shadow-xs ring-gray-950/5 dark:bg-gray-700 dark:ring-white/5">
                        <div className="flex animate-pulse space-x-4">
                          <div className="size-10 rounded-full bg-gray-200 dark:bg-gray-500"></div>
                          <div className="flex-1 space-y-3 py-1">
                            <div className="h-1.5 w-7/8 rounded bg-gray-200 dark:bg-gray-500"></div>
                            <div className="space-y-3">
                              <div className="grid grid-cols-3 gap-4">
                                <div className="col-span-2 h-1.5 rounded bg-gray-200 dark:bg-gray-500"></div>
                                <div className="col-span-1 h-1.5 rounded bg-gray-200 dark:bg-gray-500"></div>
                              </div>
                              <div className="h-1.5 rounded bg-gray-200 dark:bg-gray-500"></div>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="flex h-full flex-1 flex-col items-center justify-between p-6">
                  <div className="mt-7 flex w-full flex-1 items-center justify-center">
                    <div className="flex justify-center">
                      <div className="flex size-10 animate-bounce items-center justify-center rounded-full bg-purple-600 p-2">
                        <svg
          ...
          <BentoItem className="col-span-full md:col-span-3">
            ...
            <BentoBody className="h-112">
              <div className="-mt-27 -mr-124 -mb-8 bg-white p-16 ring ring-gray-950/5 xl:-mr-26 dark:bg-gray-950 dark:ring-white/10">
