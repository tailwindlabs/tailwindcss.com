...
function BlackFriday() {
  return (
    <Link
      ...
      className="hidden items-center gap-2 rounded-full bg-gray-950 px-2.5 py-0.5 text-xs leading-5 text-white -outline-offset-1 hover:bg-gray-800 xl:flex dark:bg-white/10 dark:hover:bg-white/20"
    >
