...
function BlackFriday() {
  return (
    <Link
      ...
      className="hidden items-center gap-2 rounded-full bg-gray-950 px-2.5 py-0.5 text-xs leading-5 text-white -outline-offset-1 hover:bg-gray-800 min-[70rem]:flex dark:bg-white/10 dark:hover:bg-white/20"
    >
      ...
      <div className="flex items-center gap-0.5">
        Black Friday Deal — over 33% off
        <svg width="2" height="2" fill="currentColor" aria-hidden="true" className="ml-2 text-gray-400">
          <circle cx="1" cy="1" r="1" />
        </svg>
        <span className="ml-2">Learn more</span>
        <svg width="3" height="6" className="ml-2 overflow-visible text-gray-300 dark:text-gray-400" aria-hidden="true">
          <path
            d="M0 0L3 3L0 6"
            fill="none"
            stroke="currentColor"
