  ...
  return (
    <>
      ...
      <div className="not-prose grid grid-cols-[auto_minmax(0,_1fr)] items-center gap-4">
        <div className="sticky top-28 z-9 bg-white lg:top-14 dark:bg-neutral-950">&nbsp;</div>
        <div className="sticky top-28 z-9 col-start-2 grid grid-cols-11 justify-items-center gap-1.5 bg-white font-medium text-neutral-950 *:rotate-180 *:[writing-mode:vertical-lr] max-sm:py-1 sm:gap-4 sm:*:rotate-0 sm:*:[writing-mode:horizontal-tb] lg:top-14 dark:bg-neutral-950 dark:text-white">
          <div>50</div>
          <div>100</div>
          <div>200</div>
          <div>300</div>
        ...
        {Object.entries(colors).map(([key, shades]) => (
          <React.Fragment key={key}>
            <p className="font-medium text-neutral-950 capitalize sm:pr-12 dark:text-white">{key}</p>
        ...
        <div className="pt-2 text-center text-neutral-500 italic max-sm:hidden sm:col-span-2 md:col-span-1 md:col-start-2 dark:text-neutral-400">
