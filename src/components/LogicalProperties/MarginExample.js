  ...
  return (
    <div className="grid md:grid-cols-2 gap-12 justify-center py-14 md:px-10 px-4 text-sm font-medium">
      <div className="grid md:gap-8 gap-4 justify-center">
        <p className="text-center font-mono">ml-3</p>
        <motion.div layout style={{ direction }} class="grid grid-flow-col items-center">
          <motion.img
            layout
          ...
          <motion.div
            layout
            className="relative ml-3 border-cyan-300 dark:border-cyan-600 border-2 rounded-[1px]"
          >
            <motion.div layout className="absolute left-[-14px] w-[11px] bg-stripes-pink h-full" />
      ...
      <div className="grid md:gap-8 gap-4 justify-center">
        <p className="text-center font-mono">ms-3</p>
        <motion.div layout style={{ direction }} className="grid grid-flow-col items-center">
          ...
          <motion.div
            layout
            className="relative ms-3 border-cyan-300 dark:border-cyan-600 border-2 rounded-[1px]"
          >
            <motion.div layout className="absolute start-[-14px] w-[11px] bg-stripes-pink h-full" />
            <p className="text-slate-700 dark:text-slate-300">
              {direction === 'ltr' ? 'Tamer Karam' : 'تامر كرم'}
            </p>
            <p className="text-slate-500">
