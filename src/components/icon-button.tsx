export function IconButton({ className, children, ...props }: React.ComponentProps<"button">) {
  return (
    <button
      type="button"
      className={`relative inline-grid size-7 place-items-center rounded-md text-neutral-950 hover:bg-neutral-950/5 dark:text-white dark:hover:bg-white/10 ${className}`}
      {...props}
    >
