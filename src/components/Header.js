    ...
    <>
      <div className="py-2 bg-gradient-to-r from-indigo-600 to-light-blue-500 overflow-hidden">
        <div className="relative max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          <BannerMarkLeft className="absolute right-1/2 transform translate-x-[-150px] translate-y-[-250px] w-[848px] h-[513px]" />
          <BannerMarkRight className="absolute left-1/2 transform translate-x-[330px] translate-y-[-357px] w-[848px] h-[513px]" />
          <div className="flex justify-center items-center">
            ...
            <span
              aria-hidden="true"
              className="mx-4 sm:mx-6 block h-6 w-px bg-white bg-opacity-20"
            ></span>
            <div>
              <a
