  ...
  return (
    ...
    <ol className="sticky ml-4 flex min-w-0 items-center gap-2 text-sm/6 whitespace-nowrap">
      <li className="flex items-center gap-2">
        <span className="text-neutral-500 dark:text-neutral-400">{section}</span>
        {CaretRight}
      </li>
      <li className="truncate text-neutral-950 dark:text-white">{title}</li>
    </ol>
  );
}

let CaretRight = (
  <svg viewBox="0 0 16 16" className="size-4 fill-neutral-950 dark:fill-neutral-500">
    <path
      fillRule="evenodd"
